...
import { LogOut, Folder, Calendar, PanelLeftClose, PanelLeftOpen, CheckSquare, BarChart2, Settings, StickyNote } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const navItems = [
    ...
    { path: '/dashboard/notes', label: 'Notes', icon: <StickyNote size={20} /> },
      ...
      <aside className="sidebar glass-panel">
        <div className="sidebar-header-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px' }}>
          <div className="sidebar-brand">
            {!isSidebarCollapsed && <h2>WorkFlowX</h2>}
          </div>
          <button 
